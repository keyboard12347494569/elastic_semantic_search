...
FEWSHOTS = [
    ("Count people per team.",
     {"index": INDEX, "size": 0, "query": {"match_all":{}},"aggs":{"by_team":{"terms":{"field":"Families_raw","size":50}}}}),
    ("People in Tokyo who joined a workshop.",
     {"index": INDEX, "query": {"bool": {"must":[{"match":{"Locations":"Tokyo, Japan"}},{"match":{"Events":"workshop"}}]}},"size":10}),
    ("Top 5 locations for cybersecurity training.",
     {"index": INDEX, "size": 0, "query": {"match":{"Events":{"query":"cybersecurity","operator":"and"}}},"aggs":{"top_locations":{"terms":{"field":"Locations_raw","size":5}}}}),
    ("list all those who lives in Vietnam",
     {"index": INDEX, "query": {"match": {"Locations":"Vietnam"}},"size":100})
]
